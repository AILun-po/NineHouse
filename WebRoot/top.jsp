...
<title>top</title>
<link href="/NineHouse/skin/css/base.css" rel="stylesheet" type="text/css"/>
...
{
  text-align:center;
	background:url(NineHouse/skin/images/frame/topitembg.gif) 0px 3px no-repeat;
	width:82px;
	height:26px;
	line-height:28px;
}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-image:url('skin/images/frame/topbg.gif')">
  <tr>
    <td width='20%' height="60"><img src="skin/images/frame/logo1.gif" width="177" height="58"/></td>
